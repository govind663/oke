        ...
        <div class="row">
            <div class="col-md-12">
                <div class="footer-text">
                    ...
                    <ul class="footer-ul">
                        <li><a class="footer-link" href="{{ route('about') }}">About OKE</a></li>
                    ...
                    <div class="footer-social-items">
                        <ul class="footer-social-list">
                            ...
                            <li class="footer-social-list-item">
                                <a href="https://www.linkedin.com/company/oranje-kracht-energy/posts/?feedView=all"
                                    target="_blank" class="footer-social-list-link"><i class="fa fa-linkedin"
        ...
        <div class="bottom-footer">
            <div class="footer-author-block">
                <div class="footer-author-text">
                    <div id="copyright">
                        Copyright © 2024 OKE. All rights reserved. Designed By
